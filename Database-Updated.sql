...
INSERT INTO `McqAnswers` VALUES (65,91,160),(66,92,164),(67,93,168),(69,90,176),(70,89,182),(71,88,186),(72,87,190),(84,85,228),(88,96,247),(89,95,251),(90,94,252),(91,94,255),(92,84,256),(93,83,261),(94,82,264),(95,86,268);
...
INSERT INTO `McqOptions` VALUES (157,91,'Ganga'),(158,91,'Cauvery'),(159,91,'Narmada'),(160,91,'Godavari'),(161,92,'north of Tropic of Cancer'),(162,92,'south of the Equator'),(163,92,'south of the Capricorn'),(164,92,'north of the Equator'),(165,93,'I and II'),(166,93,'I, II and III'),(167,93,'I, III and IV'),(168,93,'I, II and IV'),(175,90,'Tin'),(176,90,'Mercury'),(177,90,'Lead'),(178,90,'Zinc'),(179,90,'Magnesium'),(180,90,'Copper'),(181,89,'copper'),(182,89,'magnesium'),(183,89,'iron'),(184,89,'calcium'),(185,88,'Phosphorous'),(186,88,'Bromine'),(187,88,'Chlorine'),(188,88,'Helium'),(189,87,'Oxygen'),(190,87,'Hydrogen sulphide'),(191,87,'Carbon dioxide'),(228,85,'Buddhists'),(229,85,'Hindus'),(230,85,'Jains'),(231,85,'None of the above'),(244,96,'Na'),(245,96,'Ag'),(246,96,'Hg'),(247,96,'Fe'),(248,95,'electrons and neutrons'),(249,95,'electrons and protons'),(250,95,'protons and neutrons'),(251,95,'All of the above'),(252,94,'molality'),(253,94,'morality'),(254,94,'normality'),(255,94,'formality'),(256,84,'military affairs'),(257,84,'the state treasury'),(258,84,'the royal household'),(259,84,'the land revenue system'),(260,83,'Sutlej and Beas'),(261,83,'Jhelum and Chenab'),(262,83,'Ravi and Chenab'),(263,83,'Ganga and Yamuna'),(264,82,'1757'),(265,82,'1782'),(266,82,'1748'),(267,82,'1764'),(268,86,'Nirvana'),(269,86,'Sangha'),(270,86,'Buddha'),(271,86,'Dhamma');
...
--
-- Table structure for table `StudentGroupOfExam`
--

DROP TABLE IF EXISTS `StudentGroupOfExam`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `StudentGroupOfExam` (
...
--
-- Dumping data for table `StudentGroupOfExam`
--
...
INSERT INTO `TrueFalseAnswers` VALUES (28,64,_binary ''),(29,65,_binary ''),(31,67,_binary ''),(32,68,_binary ''),(33,69,_binary ''),(34,70,_binary ''),(35,71,_binary ''),(36,72,_binary ''),(37,73,_binary ''),(38,74,_binary ''),(39,75,_binary ''),(40,76,_binary ''),(41,77,_binary ''),(42,78,_binary ''),(43,79,_binary ''),(46,97,_binary ''),(47,98,_binary ''),(48,99,_binary ''),(49,100,_binary '\0');
...
INSERT INTO `Users` VALUES (65,6,'ishwar2303','12345678',_binary '');
